...
namespace Text {
    ...
    namespace ESP
    {
        ...
        // Future ESP items
        // inline std::string DroppedItems = "Dropped Items";
        // inline std::string DroppedBomb = "Bomb";
        // inline std::string DroppedWeapons = "Weapons";
        // inline std::string DroppedGrenades = "Grenades";
    }
    ...
    namespace Misc
    {
        ...
        inline std::string RadarHack = "Radar Hack";
